(function() {
    ...
    r("Promise", function(a) {
        ...
        b.prototype.K = function(f) {
            ...
            typeof d == "function" ? this.O(d, f) : this.u(f)
        }
        ;
        ...
        ;
        b.prototype.B = function(f, d) {
            if (this.i != 0)
                throw Error("Cannot settle(" + f + ", " + d + "): Promise already settled in state" + this.i);
            this.i = f;
            this.j = d;
            this.i === 2 && this.M();
            this.C()
        ...
        b.prototype.M = function() {
            ...
            h(function() {
                if (f.J()) {
                    var d = q.console;
                    typeof d !== "undefined" && d.error(f.j)
                }
            }, 1)
        }
        ;
        b.prototype.J = function() {
            ...
            typeof f === "function" ? f = new f("unhandledrejection",{
                cancelable: !0
            }) : typeof d === "function" ? f = new d("unhandledrejection",{
                cancelable: !0
        ...
        b.prototype.N = function(f) {
            var d = this.l();
            f.D(d.resolve, d.reject)
        }
        ;
        b.prototype.O = function(f, d) {
            var g = this.l();
            try {
        ...
        b.prototype.D = function(f, d) {
            ...
            var l = this;
            this.h == null ? k.i(g) : this.h.push(g);
            this.A = !0
        }
        ;
        b.resolve = e;
        ...
        b.all = function(f) {
            var d = x(f)
              , g = d.next();
            return g.done ? e([]) : new b(function(l, m) {
                function u(P) {
                    return function(Q) {
                        w[P] = Q;
                        z--;
    ...
    r("WeakMap", function(a) {
        function b(g) {
            this.h = (d += Math.random() + 1).toString();
            if (g) {
                g = x(g);
        ...
        b.prototype.get = function(g) {
            return e(g) && y(g, f) ? g[f][this.h] : void 0
        }
        ;
        b.prototype.has = function(g) {
            return e(g) && y(g, f) && y(g[f], this.h)
        }
        ;
        b.prototype.delete = function(g) {
            return e(g) && y(g, f) && y(g[f], this.h) ? delete g[f][this.h] : !1
        }
        ;
        return b
    });
    r("Map", function(a) {
        ...
        if (function() {
            ...
            try {
                ...
                var l = g.entries()
                  , m = l.next();
                if (m.done || m.value[0] != d || m.value[1] != "s")
                    return !1;
                m = l.next();
        ...
        h.prototype.delete = function(d) {
            d = e(this, d);
            return d.entry && d.list ? (d.list.splice(d.index, 1),
            d.list.length || delete this[0][d.id],
            d.entry.previous.next = d.entry.next,
            d.entry.next.previous = d.entry.previous,
            d.entry.head = null,
            this.size--,
            !0) : !1
        }
        ...
        h.prototype.has = function(d) {
            return !!e(this, d).entry
        }
        ;
        h.prototype.get = function(d) {
            return (d = e(this, d).entry) && d.value
        }
        ;
        ...
        ;
        h.prototype.forEach = function(d, g) {
            for (var l = this.entries(), m; !(m = l.next()).done; )
                m = m.value,
                d.call(g, m[1], m[0], this)
        }
        ;
        ...
        return a ? a : function(b, c, e) {
            ...
            if (typeof k == "function") {
                ...
                for (var f = 0; !(k = b.next()).done; )
                    h.push(c.call(e, k.value, f++))
            } else
                for (k = b.length,
                f = 0; f < k; f++)
                    h.push(c.call(e, b[f], f));
            return h
        }
    });
    /*
...
*/
    ...
    function D(a, b) {
        a = a.split(".");
        for (var c = A, e; a.length && (e = a.shift()); )
    ...
    function la(a, b) {
        ...
        a.X = function(e, h, k) {
            for (var f = Array(arguments.length - 2), d = 2; d < arguments.length; d++)
                f[d - 2] = arguments[d];
            return b.prototype[h].apply(e, f)
        }
    }
    ...
    : function(a, b, c) {
        for (var e = a.length, h = typeof a === "string" ? a.split("") : a, k = 0; k < e; k++)
    ...
    J.prototype.addOnDisposeCallback = function(a, b) {
        this.j ? b !== void 0 ? a.call(b) : a() : (this.l || (this.l = []),
        b && (a = a.bind(b)),
        this.l.push(a))
    }
    ;
...
*/
    ...
    n.H = function(a, b) {
        var c = this.i[a];
        if (c) {
            var e = Array(arguments.length - 1), h = arguments.length, k;
            for (k = 1; k < h; k++)
                e[k - 1] = arguments[k];
            if (this.B)
                for (k = 0; k < c.length; k++)
                    h = c[k],
                    La(this.h[h + 1], this.h[h + 2], e);
            else {
                this.u++;
                try {
                    for (k = 0,
                    h = c.length; k < h && !this.j; k++) {
                        var f = c[k];
                        this.h[f + 1].apply(this.h[f + 2], e)
                    }
                } finally {
                    if (this.u--,
    ...
    function X(a, b) {
        ...
        if (a = typeof a === "string" ? c.getElementById(a) : a) {
            ...
            for (var e = 0; e < b.length; e++)
                b[e].host && (b[e].host = b[e].host.toString().replace("http://", "https://"));
            if (!c) {
                ...
                for (var h = c.length; e < h; e++) {
                    var k = c[e].value;
                    k != null && k !== "" && k !== "null" && b.setAttribute(c[e].name, k)
                }
                ...
                if (Va.yt_embedsEnableIframeSrcWithIntent) {
                    var d = d === void 0 ? Ga : d;
                    a: if (d = d === void 0 ? Ga : d,
                    f instanceof K)
                        d = f;
                    else {
                        for (a = 0; a < d.length; ++a)
                            if (c = d[a],
                            c instanceof L && c.R(f)) {
                                d = new K(f);
                                break a
                            }
                        d = void 0
            ...
            this.h = a;
            this.h.id || (this.h.id = "widget" + ja(this.h));
            T[this.h.id] = this;
    ...
    n.destroy = function() {
        this.h && this.h.id && (T[this.h.id] = null);
        var a = this.j;
        ...
        Z && (Z[this.id] = null);
        this.options = null;
        this.h && this.A && this.h.removeEventListener("load", this.A);
        this.l = this.h = null
    }
    ;
    function ab(a, b, c) {
    ...
    n.S = function() {
        bb(this) || clearInterval(this.i)
    }
    ;
    function bb(a) {
        if (!a.h || !a.h.contentWindow)
            return !1;
        a.sendMessage({
            event: "listening"
        });
    ...
    function Ya(a) {
        ...
        a.i = setInterval(a.B, b);
        a.h && (a.A = function() {
            clearInterval(a.i);
            a.i = setInterval(a.B, b)
        }
        ,
        a.h.addEventListener("load", a.A))
    }
    function db(a) {
    ...
    n.sendMessage = function(a) {
        ...
        a.channel = "widget";
        a = JSON.stringify(a);
        var b = Na(this.h.src || "").replace("http:", "https:");
        if (this.h.contentWindow)
            try {
                this.h.contentWindow.postMessage(a, b)
            } catch (c) {
    ...
    function Wa(a, b) {
        ...
        window.location.href && E(["debugjs", "debugcss"], function(h) {
            ...
            b: {
                var d = 0;
                for (var g = h.length; (d = k.indexOf(h, d)) >= 0 && d < f; ) {
                    var l = k.charCodeAt(d - 1);
                    if (l == 38 || l == 63)
                        if (l = k.charCodeAt(d + g),
                        !l || l == 61 || l == 38 || l == 35)
                            break b;
                    d += g + 1
                }
            ...
            if (d < 0)
                ...
                if (g < 0 || g > f)
                    g = f;
                d += h.length + 1;
                k = decodeURIComponent(k.slice(d, g !== -1 ? g : 0).replace(/\+/g, " "))
            }
            k !== null && (c[h] = k)
        });
    ...
    function eb(a, b) {
        if (B(b)) {
            ...
            a.h.setAttribute("title", b))) : (a.videoTitle = "",
            a.h.setAttribute("title", "YouTube " + Y(a, "title"))))
        }
    }
    function fb(a, b) {
        b = x(b);
        ...
        try {
            ...
            c = b.next())
                h.o = c.value,
                a[h.o] || (h.o === "getCurrentTime" ? a[h.o] = function() {
                ...
                : Ta(h.o) ? a[h.o] = function(k) {
                    return function() {
                        this.playerInfo = {};
                        this.v = {};
                        ab(this, k.o, arguments);
                        return this
                    }
                }(h) : Ua(h.o) ? a[h.o] = function(k) {
                    return function() {
                        var f = k.o
                          , d = 0;
                        f.search("get") === 0 ? d = 3 : f.search("is") === 0 && (d = 2);
                        return this.playerInfo[f.charAt(d).toLowerCase() + f.substring(d + 1)]
                    }
                }(h) : a[h.o] = function(k) {
                    return function() {
                        ab(this, k.o, arguments);
    ...
    n.getVideoEmbedCode = function() {
        ...
        b = Math.floor(b);
        c = Math.floor(c);
        var e = this.videoTitle;
        a = Ka(a);
        e = Ka(e != null ? e : "YouTube video player");
        return '<iframe width="' + b + '" height="' + c + '" src="' + a + '" title="' + (e + '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>')
    }
    ;
    ...
    function cb(a, b, c) {
        Z || (Z = {},
        gb = new Set,
        ib.addEventListener("message", function(e) {
            a: if (gb.has(e.origin)) {
                try {
                ...
                if (k && e.origin === k.P)
                    ...
                    case "apiInfoDelivery":
                        if (B(h))
                            for (var f in h)
                                h.hasOwnProperty(f) && (e.v[f] = h[f]);
                        break;
                    case "infoDelivery":
                        eb(e, h);
                        break;
                    case "initialDelivery":
                        B(h) && (clearInterval(e.i),
                        e.playerInfo = {},
                        e.v = {},
                        fb(e, h.apiInterface),
                        eb(e, h));
    ...
    var jb = A.onYTReady;
    jb && jb();
    var kb = A.onYouTubeIframeAPIReady;
    kb && kb();
    var lb = A.onYouTubePlayerAPIReady;
    lb && lb();
}
).call(this);
